  ...
  const DEX = [
    {
      ...
      anomaly: { discoverer: 'Mapleaudino' },
    ...
    },
    {
      ...
      anomaly: { discoverer: 'eliasderzocker2' },
    ...
    },
    {
      ...
      anomaly: { discoverer: 'thechosenbug' },
    ...
    },
{
      ...
      anomaly: { discoverer: 'mymiguelito' },
    ...
    },
{
    ...
    {
      dex: '054', name: 'Petitour', category: 'Builder', types: ['BUG'],
      height: '?', weight: '?', catchRate: 200, found: ['Route 7'],
      abilities: ['Lightning Rod'],
      hidden: 'No Guard',
      stats: { HP: 50, ATK: 54, DEF: 54, SPA: 40, SPD: 70, SPE: 42 },
      flavor: 'Petitour needs immense electricity to evolve. Its back antenna draws impulses, but a lightning strike could fry it instead.',
      evo: { to: '055' },
      levelMoves: [
        M('1', 'Tackle'),
        M('1', 'Flash'),
        ...
        M('17', 'Endure'),
        M('21', 'Confuse Ray'),
        M('25', 'Parabolic Charge'),
        M('30', 'Signal Beam'),
        M('34', 'Iron Defense'),
        M('38', 'Iron Head'),
        M('42', 'Zing Zap'),
        M('46', 'Electric Terrain'),
        M('50', 'Wild Charge'),
      ],
      eggMoves: [
        EGG('Pounce'),
      ...
      evYield: { ATK: 1 }, baseFriendship: 50, baseExp: 63, growthRate: 'Medium',
      eggGroups: ['Bug'], gender: { m: 50, f: 50 }, eggCycles: 3840,
    },
    {
      dex: '055', name: 'Voltiguer', category: 'Architect', types: ['BUG', 'ELECTRIC'],
      height: '?', weight: '?', catchRate: 75, found: [],
      abilities: ['Levitate'],
      hidden: 'No Guard',
      stats: { HP: 70, ATK: 69, DEF: 69, SPA: 90, SPD: 100, SPE: 72 },
      flavor: 'This Pokemon\'s body is almost entirely made up of electricity. Voltiguer\'s arm cannons can fire beams often reaching 500 million volts.',
      levelMoves: [
        M('1', 'Fell Stinger'),
        M('1', 'Fell Stinger'),
        M('1', 'Wild Charge'),
      ...
      evYield: { ATK: 1, SPD: 1 }, baseFriendship: 50, baseExp: 173, growthRate: 'Medium',
      eggGroups: ['Bug'], gender: { m: 50, f: 50 }, eggCycles: 3840,
    },
{
    ...
    },
{
    ...
    {
      dex: '065', name: 'Walewep', category: 'Sidestep', types: ['FIGHTING'],
      height: '?', weight: '?', catchRate: 190, found: ['Route 7'],
      abilities: ['Steadfast', 'Scrappy'],
      hidden: 'Stampede',
      stats: { HP: 60, ATK: 63, DEF: 55, SPA: 42, SPD: 50, SPE: 54 },
      flavor: 'Walewep uses its small stature to stay nimble, relying on instinct to dodge and block attacks before striking back with a swift counter.',
      levelMoves: [
        M('1', 'Tackle'),
        M('1', 'Leer'),
        M('5', 'Endure'),
      ...
      evYield: { ATK: 1 }, baseFriendship: 50, baseExp: 70, growthRate: 'Slow',
      eggGroups: ['Field'], gender: { m: 80, f: 20 }, eggCycles: 3840,
    },
    {
    ...
    },
{
      ...
      anomaly: { discoverer: 'Sassyshoelace' },
    ...
    },
{
      ...
      anomaly: { discoverer: 'allen041612' },
      evYield: { ATK: 2 }, baseFriendship: 50, baseExp: 184, growthRate: 'Slow',
      eggGroups: ['Mineral'], gender: { m: 50, f: 50 }, eggCycles: 6400,
    },
{
      ...
      anomaly: { discoverer: 'mickiewicz333' },
      evYield: { SPE: 2 }, baseFriendship: 50, baseExp: 184, growthRate: 'Slow',
      eggGroups: ['Mineral'], gender: { m: 50, f: 50 }, eggCycles: 6400,
    },
{
    ...
    },
{
    ...
    {
      dex: '079', name: 'Bunlet', category: 'Pork Bun', types: ['FAIRY'],
      height: '?', weight: '?', catchRate: 120, found: ['Route 6'],
      abilities: ['Food Coma', 'Well-Baked-Body'],
      hidden: 'Unaware',
      stats: { HP: 50, ATK: 50, DEF: 52, SPA: 30, SPD: 68, SPE: 40 },
      flavor: 'Bunlet are born from fields of wheat, aiding in their growth. Are a known source of natural yeast.',
      evo: { to: '080' },
      levelMoves: [
        M('1', 'Tackle'),
        M('1', 'Mud Sport'),
      ...
      evYield: { SPD: 1 }, baseFriendship: 50, baseExp: 72, growthRate: 'Eratic',
      eggGroups: ['Field'], gender: { m: 50, f: 50 }, eggCycles: 3840,
    },
    {
      dex: '080', name: 'Boarger', category: 'Pork Burger', types: ['FAIRY'],
      height: '?', weight: '?', catchRate: 60, found: [],
      abilities: ['Food Coma', 'Well-Baked-Body'],
      hidden: 'Unaware',
      stats: { HP: 100, ATK: 70, DEF: 82, SPA: 50, SPD: 98, SPE: 50 },
      flavor: 'Boargers seem to be the original source of where burgers came from, though surprisingly Boargers don\'t taste as well as they look.',
      levelMoves: [
        M('1', 'Overcook'),
        M('1', 'Overcook'),
        M('1', 'Autotomize'),
      ...
      evYield: { HP: 1, SPD: 1 }, baseFriendship: 50, baseExp: 181, growthRate: 'Eratic',
      eggGroups: ['Field'], gender: { m: 50, f: 50 }, eggCycles: 3840,
    },
{
    ...
    },
{
    ...
    {
      dex: '101', name: 'Scrufpup', category: 'Scout', types: ['GRASS'],
      height: '?', weight: '?', catchRate: 230, found: ['Route 6'],
      abilities: ['Grass pelt', 'Moxie'],
      hidden: 'Grassy Surge',
      stats: { HP: 60, ATK: 40, DEF: 60, SPA: 30, SPD: 60, SPE: 50 },
      flavor: 'Playful Scrufpup hoards rocks like treasure. Over time, they harden into rocky pads on its paws.',
      evo: { to: '102' },
      levelMoves: [
        M('1', 'Tackle'),
        M('3', 'Growl'),
      ...
      evYield: { HP: 1 }, baseFriendship: 50, baseExp: 55, growthRate: 'Medium',
      eggGroups: ['Field'], gender: { m: 50, f: 50 }, eggCycles: 5120,
    },
    {
      dex: '102', name: 'Cyocotta', category: 'Seam Break', types: ['GRASS', 'ROCK'],
      height: '?', weight: '?', catchRate: 110, found: [],
      abilities: ['Grass pelt', 'Moxie'],
      hidden: 'Grassy Surge',
      stats: { HP: 90, ATK: 70, DEF: 80, SPA: 70, SPD: 70, SPE: 60 },
      flavor: 'Its rocky pads sharpen into talons. With a single swipe, its stone claws can crack massive rocks.',
      evo: { to: '103' },
      levelMoves: [
        M('1', 'Scratch'),
        M('1', 'Growl'),
      ...
      evYield: { HP: 1, DEF: 1 }, baseFriendship: 50, baseExp: 130, growthRate: 'Medium',
      eggGroups: ['Field'], gender: { m: 50, f: 50 }, eggCycles: 5120,
    },
    {
      dex: '103', name: 'Dendrir', category: 'Grove Titan', types: ['GRASS', 'ROCK'],
      height: '?', weight: '?', catchRate: 45, found: [],
      abilities: ['Grass pelt', 'Moxie'],
      hidden: 'Grassy Surge',
      stats: { HP: 110, ATK: 85, DEF: 100, SPA: 70, SPD: 80, SPE: 75 },
      flavor: 'Forests guarded by Dendrir endure for centuries, as intruders soon fear the scrape of its claws across the earth.',
      levelMoves: [
        M('1', 'Stone Edge'),
        M('1', 'Stone Edge'),
        M('1', 'Scratch'),
      ...
      evYield: { HP: 2, DEF: 1 }, baseFriendship: 50, baseExp: 250, growthRate: 'Medium',
      eggGroups: ['Field'], gender: { m: 50, f: 50 }, eggCycles: 5120,
    },
{
    ...
    },
{
    ...
    {
      dex: '111', name: 'SC0R-910', category: 'Luminary', types: ['ROCK', 'LIGHT'],
      height: '?', weight: '?', catchRate: 150, found: ['Namano Cave'],
      abilities: ['Clear Body', 'Analytic'],
      hidden: 'Download',
      stats: { HP: 50, ATK: 59, DEF: 81, SPA: 59, SPD: 81, SPE: 20 },
      flavor: 'This ancient Pokémon has existed since dawn. Scientists failed to alter it, yet many believe it inspired human invention.',
      evo: { to: '112' },
      levelMoves: [
        M('1', 'Hidden Power'),
        M('1', 'Harden'),
      ...
      evYield: { DEF: 1 }, baseFriendship: 30, baseExp: 66, growthRate: 'Slow',
      eggGroups: ['Gender Unknown'], gender: null, eggCycles: 5120,
    },
    {
      dex: '113', name: 'Radbit', category: 'Shock Hop', types: ['POISON', 'ELECTRIC'],
      height: '?', weight: '?', catchRate: 250, found: ['Route 9', 'Namano Cave'],
      abilities: ['Static', 'Poison Touch'],
      hidden: 'Volt Absorb',
      stats: { HP: 60, ATK: 70, DEF: 40, SPA: 60, SPD: 30, SPE: 50 },
      flavor: 'Radbit channels both poison and electricity through their cheeks, it speeds past enemies by electrifying the field and poisoning opponents.',
      evo: { to: '114' },
      levelMoves: [
        M('1', 'Acid'),
        M('4', 'Thunder Shock'),
      ...
      evYield: { ATK: 1 }, baseFriendship: 50, baseExp: 65, growthRate: 'Fast',
      eggGroups: ['Water1'], gender: { m: 50, f: 50 }, eggCycles: 5120,
    },
    {
      dex: '114', name: 'Raditoad', category: 'Venom Dash', types: ['POISON', 'ELECTRIC'],
      height: '?', weight: '?', catchRate: 70, found: [],
      abilities: ['Static', 'Poison Touch'],
      hidden: 'Volt Absorb',
      stats: { HP: 96, ATK: 131, DEF: 90, SPA: 70, SPD: 63, SPE: 60 },
      flavor: 'Raditoad becomes so fast it you can barely see it move after it\'s run over 1000 miles, the only thing that remains is poisonous radiation and some sparks.',
      levelMoves: [
        M('1', 'Drain Punch'),
        M('1', 'Drain Punch'),
        M('1', 'Acid'),
      ...
      evYield: { ATK: 2 }, baseFriendship: 50, baseExp: 170, growthRate: 'Fast',
      eggGroups: ['Water1'], gender: { m: 50, f: 50 }, eggCycles: 5120,
    },
    {
      dex: '115', name: 'Mimimite', category: 'Disguise', types: ['GHOST', 'FAIRY'],
      height: '?', weight: '?', catchRate: 45, found: [],
      abilities: ['Disguise'],
      hidden: 'Rocky Payload',
      stats: { HP: 55, ATK: 90, DEF: 90, SPA: 50, SPD: 115, SPE: 76 },
      flavor: 'No one knows where Mimimite came from. Some say it once wore another disguise, but copied Sedimite as its fame surged.',
      levelMoves: [
        M('1', 'Pound'),
        M('1', 'Splash'),
        M('1', 'Astonish'),
      ...
      evYield: { SPD: 2 }, baseFriendship: 50, baseExp: 167, growthRate: 'Medium',
      eggGroups: ['Amorphous'], gender: { m: 50, f: 50 }, eggCycles: 5120,
    },
  ];
